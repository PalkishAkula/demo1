...
export default function OpenGraphImage() {
  const site = getSite();
  const locality = site.type === "dental" ? "Benz Circle · Vijayawada" : site.type === "diagnostics" ? "Governorpet · Vijayawada" : site.type === "gym" ? "Patamata · Vijayawada" : "Vijayawada · Andhra Pradesh";
